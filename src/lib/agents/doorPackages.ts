...
Extrae o actualiza apuntes en primera persona del singular.`
  ...
  intereses: {
    ...
    guardrails: [
      ...
      'NIVEL DE INTERÉS / PASIÓN (peso): Reservado peso = 3 (Pasión destacada) EXCLUSIVAMENTE si el usuario expresa pasión explicita ("me apasiona", "mi pasión", "pasión absoluta", "mi mayor afición"). Si el usuario dice que algo le gusta, le encanta o menciona su película/obra favorita dentro de un género ("me gusta", "me encanta", "mi película favorita es..."), asigna peso = 2 (Interés habitual). Si es curiosidad ("me llama la atención"), asigna peso = 1.',
...
Analiza pasiones y gustos expresados. Reservado peso = 3 ÚNICAMENTE a expresiones explícitas de pasión ("me apasiona", "mi pasión"). Para cosas que gustan o encantan ("me gusta", "me encanta"), asigna peso = 2. Escribe etiquetas separadas por espacios sin CamelCase. NUNCA pongas el propio título de la ficha como etiqueta de esa ficha (usa categorías superiores como #Cine o #Tecnología). Cuando enriquezcas una ficha (action = "enrich"), reestructura y redacta el texto completo de forma cohesiva sin repetir frases redundantes. REDACTA SIEMPRE EL CONTENIDO EN PRIMERA PERSONA DEL SINGULAR.`
  },
  personas: {
    doorId: 'personas',
    category: 'mapa',
