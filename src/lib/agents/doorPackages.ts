...
Extrae o actualiza apuntes en primera persona del singular.`
  ...
  intereses: {
    ...
    guardrails: [
      ...
      'TÍTULOS ESPECÍFICOS Y EVOCADORES: Evita nombres genéricos de una sola palabra (como "Cine", "Deporte", "Música", "Lectura", "Tecnología", "Viajes"). En su lugar, el título debe ser descriptivo e interesante (ej: usa "Cine clásico de misterio", "Práctica de running y pádel", "Coleccionismo de vinilos de jazz", "Novelas de ciencia ficción", "Viajar por el sudeste asiático").',
...
Analiza pasiones y gustos expresados. EVITA TÍTULOS GENÉRICOS de una palabra como "Cine" o "Deporte"; genera títulos descriptivos de 3-4 palabras que detallen el interés (ej: "Pasión por el cine clásico", "Running y pádel regular"). Asigna peso = 3 (Pasión destacada / Favorito con corazón) a expresiones explícitas de pasión ("me apasiona", "mi pasión") o si algo se declara favorito/preferido ("mi grupo favorito", "mi película favorita", "mi plato preferido"). Para cosas que gustan o encantan, asigna peso = 2. Escribe etiquetas separadas por espacios sin CamelCase. NUNCA pongas el propio título de la ficha como etiqueta de esa ficha. Cuando enriquezcas una ficha (action = "enrich"), reestructura y redacta el texto completo de forma cohesiva sin repetir frases redundantes. REDACTA SIEMPRE EL CONTENIDO EN PRIMERA PERSONA DEL SINGULAR.`
  ...
  personas: {
    ...
    guardrails: [
      ...
      'TÍTULO: Nombre de la persona (ej: "Alejandro", "Marta", "David"). Si detectas que ya existe otra persona con el mismo nombre en la lista de elementos existentes del usuario, añade obligatoriamente el apellido o una palabra/rol diferenciador para evitar colisiones (ej: "David de pádel", "David García", "Marc de la oficina").',
