...
4. "tags": Extrae etiquetas temáticas generales y sus subgrupos o géneros temáticos con '#' (ej: "#Cine", "#CineDeTerror", "#CienciaFicción", "#Literatura", "#NovelaNegra", "#Música", "#Rock", "#Jazz", "#Deporte", "#Pádel", "#Series"). IMPORTANTE: NUNCA generes etiquetas con nombres de obras específicas, películas concretas, libros, o nombres propios de autores o personas (ej: NUNCA "#LaCasaDelDragon", "#Nolan", "#King").
